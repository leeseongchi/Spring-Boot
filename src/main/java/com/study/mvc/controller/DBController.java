...
public class DBController {
    ...
    public ResponseEntity<?> putStudy(
        ...
        // 전체 수정    원래값: {nickname: aaa, password: 1234} => 수정값: {nickname: "", password: 1111} => 결과값: {nickname: "", password: 1111}
    ...
    public ResponseEntity<?> patchStudy(
            @PathVariable int id,
            @RequestBody DBStudyReqDto dbStudyReqDto) {
        // 부분 수정    원래값: {nickname: aaa, password: 1234} => 수정값: {nickname: "", password: 1111} => 결과값: {nickname: aaa, password: 1111}
